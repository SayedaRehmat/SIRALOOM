...
class Settings(BaseSettings):
    ...
    genebe_base_url: str = "https://api.genebe.net/cloud/api-public/v1"
    ...
    genebe_gnomad_resource_version: str = "4.1-provider-aggregate"
    gnomad_enabled: bool = False
    gnomad_graphql_endpoint: str = "https://gnomad.broadinstitute.org/api"
